...
//           labelSelector =
//             Some(LoadBalancerTargetLabelSelector1("role=worker,environment=production")),
//           usePrivateIp = Some(true)
//         )
//       )
//     )
...
//           server = Some(LoadBalancerTargetServer1(123456)),
//           labelSelector =
//             Some(LoadBalancerTargetLabelSelector1("role=web,environment=production")),
//           usePrivateIp = Some(true)
//         )
//       )
//     )
...
//   val kubelbTarget = LoadBalancerTarget(
//     `type` = LoadBalancerTarget1Enums.Type.`server`,
//     ip = None,
//     labelSelector = None,
//     server = Some(
