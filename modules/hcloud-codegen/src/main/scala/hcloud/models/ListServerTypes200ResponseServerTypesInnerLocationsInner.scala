...
/** A [Location](#tag/locations) (containing only id and name) and Server Type
  * specific metadata.
  */
case class ListServerTypes200ResponseServerTypesInnerLocationsInner(
    ...
    @named("recommended") recommended: Option[Boolean] = scala.None,
