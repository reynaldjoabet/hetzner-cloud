...
/** LoadBalancerTargetLabelSelector Label selector used to determine targets.
  * Only present for target type \"label_selector\".
  */
case class LoadBalancerTargetLabelSelector(
    /* Label selector. */
