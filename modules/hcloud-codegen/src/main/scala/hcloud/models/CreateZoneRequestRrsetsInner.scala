...
case class CreateZoneRequestRrsetsInner(
    ...
    @named("type") `type`: CreateZoneRequestRrsetsInnerEnums.Type,
    ...
    @named("records") records: Seq[Record],
...
object CreateZoneRequestRrsetsInnerEnums:
  enum Type:
    case `A`
    case `AAAA`
    case `CAA`
...
end CreateZoneRequestRrsetsInnerEnums
