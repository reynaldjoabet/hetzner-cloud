...
case class GetLoadBalancerMetrics200ResponseMetricsTimeSeriesValue(
    /* Metrics Timestamps with values. */
    @named("values") values: Seq[Seq[
      GetLoadBalancerMetrics200ResponseMetricsTimeSeriesValueValuesInnerInner
    ]]
)
