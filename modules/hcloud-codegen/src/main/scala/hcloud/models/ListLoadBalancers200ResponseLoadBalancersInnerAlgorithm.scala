...
/** Algorithm of the Load Balancer.
  */
case class ListLoadBalancers200ResponseLoadBalancersInnerAlgorithm(
    /* Type of the algorithm. */
    @named(
      "type"
    ) `type`: ListLoadBalancers200ResponseLoadBalancersInnerAlgorithmEnums.Type
)

object ListLoadBalancers200ResponseLoadBalancersInnerAlgorithmEnums:
  enum Type:
    case `round_robin`
...
end ListLoadBalancers200ResponseLoadBalancersInnerAlgorithmEnums
