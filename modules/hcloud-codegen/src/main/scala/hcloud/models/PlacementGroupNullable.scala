...
/** PlacementGroupNullable The placement group the server is assigned to.
  */
case class PlacementGroupNullable(
    ...
    @named("type") `type`: PlacementGroupNullableEnums.Type,
...
object PlacementGroupNullableEnums:
  enum Type:
    case `spread`
...
end PlacementGroupNullableEnums
