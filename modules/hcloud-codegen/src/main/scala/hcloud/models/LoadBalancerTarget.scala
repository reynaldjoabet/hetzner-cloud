...
case class LoadBalancerTarget(
    ...
    @named("server") server: Option[LoadBalancerTargetServer] = scala.None,
    ...
    @named("health_status") healthStatus: Option[
      Seq[LoadBalancerTargetHealthStatusInner]
    ] = scala.None,
    ...
    @named("targets") targets: Option[Seq[LoadBalancerTargetTarget]] =
      scala.None
)
