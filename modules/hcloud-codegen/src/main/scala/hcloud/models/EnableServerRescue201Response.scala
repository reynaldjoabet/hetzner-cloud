...
/** The `root_password` key in the reply contains the root password that can be
  * used to access the booted rescue system.
  */
case class EnableServerRescue201Response(
