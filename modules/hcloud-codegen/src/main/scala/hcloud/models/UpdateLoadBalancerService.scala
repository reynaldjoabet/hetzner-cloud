...
case class UpdateLoadBalancerService(
    ...
    @named("protocol") protocol: Option[
      UpdateLoadBalancerServiceEnums.Protocol
    ] = scala.None,
    /* Port the Load Balancer will balance to. */
    @named("destination_port") destinationPort: Option[Int] = scala.None,
    /* Is Proxyprotocol enabled or not. */
    @named("proxyprotocol") proxyprotocol: Option[Boolean] = scala.None,
    @named("health_check") healthCheck: Option[
      UpdateLoadBalancerServiceHealthCheck
    ] = scala.None,
    @named("http") http: Option[LoadBalancerServiceHTTP1] = scala.None
)

object UpdateLoadBalancerServiceEnums:
  enum Protocol:
    case `tcp`
    case `http`
    case `https`
...
end UpdateLoadBalancerServiceEnums
