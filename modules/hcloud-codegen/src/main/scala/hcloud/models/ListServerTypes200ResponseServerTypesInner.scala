...
case class ListServerTypes200ResponseServerTypesInner(
    ...
    @named("prices") prices: Seq[
      ListLoadBalancerTypes200ResponseLoadBalancerTypesInnerPricesInner
    ],
    /* Type of Server boot drive. Local has higher speed. Network has better availability. */
    @named(
      "storage_type"
    ) storageType: ListServerTypes200ResponseServerTypesInnerEnums.StorageType,
    /* Type of cpu. */
    @named(
      "cpu_type"
    ) cpuType: ListServerTypes200ResponseServerTypesInnerEnums.CpuType,
    /* CPU architecture of the Server Type.  */
    @named(
      "architecture"
    ) architecture: ListServerTypes200ResponseServerTypesInnerEnums.Architecture,
    ...
    @named("deprecation") deprecation: Option[DeprecationInfo1] = scala.None
)

object ListServerTypes200ResponseServerTypesInnerEnums:
  enum StorageType:
    case `local`
    case `network`
...
end ListServerTypes200ResponseServerTypesInnerEnums
