...
/** This field is deprecated, as all of it's properties are deprecated. [Server
  * Types](#tag/server-types) supported and available in this [Data
  * Center](#tag/data-centers).
  */
case class ListDatacenters200ResponseDatacentersInnerServerTypes(
