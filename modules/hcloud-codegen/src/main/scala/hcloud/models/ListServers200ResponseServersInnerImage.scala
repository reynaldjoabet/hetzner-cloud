...
import com.github.plokhotnyuk.jsoniter_scala.macros.named
   ...
   */
case class ListServers200ResponseServersInnerImage(
  /* ID of the [Image](#tag/images). */
  @named("id") id: Long,
  /* Type of the Image. */
  @named("type") `type`: ListServers200ResponseServersInnerImageEnums.Type,
  /* Status of the Image. */
  @named("status") status: ListServers200ResponseServersInnerImageEnums.Status,
  ...
  @named("created_from") createdFrom: ListImages200ResponseImagesInnerCreatedFrom,
  /* ID of Server the Image is bound to. Only set for Images of type `backup`. */
  @named("bound_to") boundTo: Long,
  /* Flavor of operating system contained in the Image. */
  @named("os_flavor") osFlavor: ListServers200ResponseServersInnerImageEnums.OsFlavor,
  /* Operating system version. */
  @named("os_version") osVersion: String,
  @named("protection") protection: ListFloatingIps200ResponseFloatingIpsInnerProtection,
  ...
  @named("deprecated") deprecated: OffsetDateTime,
  ...
  @named("architecture") architecture: ListServers200ResponseServersInnerImageEnums.Architecture,
  /* Indicates that rapid deploy of the Image is available. */
  @named("rapid_deploy") rapidDeploy: Option[Boolean] = scala.None
)

object ListServers200ResponseServersInnerImageEnums:
  enum Type:
    case `system`
    case `app`
    case `snapshot`
...
end ListServers200ResponseServersInnerImageEnums
