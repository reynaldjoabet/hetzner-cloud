...
case class ListServers200ResponseServersInnerImage(
    ...
    @named(
      "status"
    ) status: ListServers200ResponseServersInnerImageEnums.Status,
    ...
    @named(
      "created_from"
    ) createdFrom: ListImages200ResponseImagesInnerCreatedFrom,
    /* ID of Server the Image is bound to. Only set for Images of type `backup`. */
    @named("bound_to") boundTo: Long,
    /* Flavor of operating system contained in the Image. */
    @named(
      "os_flavor"
    ) osFlavor: ListServers200ResponseServersInnerImageEnums.OsFlavor,
    /* Operating system version. */
    @named("os_version") osVersion: String,
    @named(
      "protection"
    ) protection: ListFloatingIps200ResponseFloatingIpsInnerProtection,
    ...
    @named(
      "architecture"
    ) architecture: ListServers200ResponseServersInnerImageEnums.Architecture,
...
object ListServers200ResponseServersInnerImageEnums:
  ...
  object Architecture:
    import com.github.plokhotnyuk.jsoniter_scala.macros.*
    import com.github.plokhotnyuk.jsoniter_scala.core.*
    given architectureCodec: JsonValueCodec[Architecture] =
      JsonCodecMaker.make {
        CodecMakerConfig
          .withAdtLeafClassNameMapper { x =>
            JsonCodecMaker.simpleClassName(x) match
