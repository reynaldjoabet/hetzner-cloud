...
case class ListNetworks200ResponseNetworksInnerSubnetsInner(
    /* Type of subnet.  */
    @named(
      "type"
    ) `type`: ListNetworks200ResponseNetworksInnerSubnetsInnerEnums.Type,
...
object ListNetworks200ResponseNetworksInnerSubnetsInnerEnums:
  enum Type:
    case `cloud`
    case `server`
    case `vswitch`
...
end ListNetworks200ResponseNetworksInnerSubnetsInnerEnums
