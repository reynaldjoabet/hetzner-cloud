...
case class Rule(
    ...
    @named("direction") direction: RuleEnums.Direction,
    /* Network protocol to apply the rule for. */
    @named("protocol") protocol: RuleEnums.Protocol,
    ...
    @named("source_ips") sourceIps: Option[Seq[String]] = scala.None,
    ...
    @named("destination_ips") destinationIps: Option[Seq[String]] = scala.None,
    ...
    @named("port") port: Option[String] = scala.None
)
