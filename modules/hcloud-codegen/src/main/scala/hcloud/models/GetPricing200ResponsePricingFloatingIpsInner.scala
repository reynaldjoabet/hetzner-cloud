...
case class GetPricing200ResponsePricingFloatingIpsInner(
    /* Type of [Floating IP](#tag/floating-ips) the price is for. */
    @named(
      "type"
    ) `type`: GetPricing200ResponsePricingFloatingIpsInnerEnums.Type,
...
object GetPricing200ResponsePricingFloatingIpsInnerEnums:
  enum Type:
    case `ipv4`
    case `ipv6`
...
end GetPricing200ResponsePricingFloatingIpsInnerEnums
