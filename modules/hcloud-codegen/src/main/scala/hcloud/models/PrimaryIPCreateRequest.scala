...
case class PrimaryIPCreateRequest(
    /* Name of the Resource. Must be unique per Project. */
    @named("name") name: String,
    /* [Primary IP](#tag/primary-ips) type. */
    @named("type") `type`: PrimaryIPCreateRequestEnums.Type,
    /* Type of resource the [Primary IP](#tag/primary-ips) can get assigned to.  Currently [Primary IPs](#tag/primary-ips) can only be assigned to [Servers](#tag/servers), therefore this field must be set to `server`.  */
    @named(
      "assignee_type"
    ) assigneeType: PrimaryIPCreateRequestEnums.AssigneeType,
    ...
    @named("datacenter") datacenter: Option[PrimaryIPCreateRequestDatacenter] =
      scala.None,
    @named("location") location: Option[PrimaryIPCreateRequestLocation] =
      scala.None,
...
object PrimaryIPCreateRequestEnums:
  enum Type:
    case `ipv4`
    case `ipv6`
...
end PrimaryIPCreateRequestEnums
