...
case class ListIsos200ResponseIsosInner(
    ...
    /* Type of the ISO. */
    @named("type") `type`: ListIsos200ResponseIsosInnerEnums.Type,
    ...
    @named(
      "architecture"
    ) architecture: ListIsos200ResponseIsosInnerEnums.Architecture
)

object ListIsos200ResponseIsosInnerEnums:
  enum Type:
    case `public`
    case `private`
...
end ListIsos200ResponseIsosInnerEnums
