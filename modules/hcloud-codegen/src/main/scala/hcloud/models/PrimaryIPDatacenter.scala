...
/** **Deprecated**: This property is deprecated and will be removed after the 1
  * July 2026. Use the `location` property instead. [Data
  * Center](#tag/data-centers) of the [Primary IP](#tag/primary-ips).
  */
case class PrimaryIPDatacenter(
    ...
    @named(
      "location"
    ) location: ListDatacenters200ResponseDatacentersInnerLocation,
    @named(
      "server_types"
    ) serverTypes: ListDatacenters200ResponseDatacentersInnerServerTypes
)
