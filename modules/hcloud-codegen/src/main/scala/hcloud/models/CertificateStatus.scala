...
/** Current status of a type `managed` Certificate, always *null* for type
  * `uploaded` Certificates.
  */
case class CertificateStatus(
    /* Status of the issuance process of the Certificate. */
    @named("issuance") issuance: Option[CertificateStatusEnums.Issuance] =
      scala.None,
    /* Status of the renewal process of the Certificate. */
    @named("renewal") renewal: Option[CertificateStatusEnums.Renewal] =
      scala.None,
