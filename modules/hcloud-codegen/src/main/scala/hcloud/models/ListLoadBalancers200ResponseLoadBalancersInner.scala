...
case class ListLoadBalancers200ResponseLoadBalancersInner(
    ...
    @named(
      "public_net"
    ) publicNet: ListLoadBalancers200ResponseLoadBalancersInnerPublicNet,
    ...
    @named(
      "location"
    ) location: ListFloatingIps200ResponseFloatingIpsInnerHomeLocation,
    @named(
      "load_balancer_type"
    ) loadBalancerType: ListLoadBalancerTypes200ResponseLoadBalancerTypesInner,
    @named(
      "protection"
    ...
    @named(
      "algorithm"
    ) algorithm: ListLoadBalancers200ResponseLoadBalancersInnerAlgorithm,
