...
case class ZoneAuthoritativeNameservers(
  ...
  @named("delegation_status") delegationStatus: Option[ZoneAuthoritativeNameserversEnums.DelegationStatus] = scala.None
)
...
object ZoneAuthoritativeNameserversEnums:
  ...
  object DelegationStatus:
    ...
    given delegationStatusCodec: JsonValueCodec[DelegationStatus] = JsonCodecMaker.make {
      CodecMakerConfig
