...
/** [Location](#tag/locations) ID or name the [Primary IP](#tag/primary-ips)
  * will be bound to. Omit if `assignee_id`/`assignee_type` or `datacenter` are
  * provided.
  */
case class PrimaryIPCreateRequestLocation(
)
