...
case class ListImages200ResponseImagesInner(
  /* ID of the [Image](#tag/images). */
  @named("id") id: Long,
  /* Type of the Image. */
  @named("type") `type`: ListImages200ResponseImagesInnerEnums.Type,
  /* Status of the Image. */
  @named("status") status: ListImages200ResponseImagesInnerEnums.Status,
  ...
  @named("os_flavor") osFlavor: ListImages200ResponseImagesInnerEnums.OsFlavor,
  ...
  @named("architecture") architecture: ListImages200ResponseImagesInnerEnums.Architecture,
  /* Indicates that rapid deploy of the Image is available. */
  @named("rapid_deploy") rapidDeploy: Option[Boolean] = scala.None
)

object ListImages200ResponseImagesInnerEnums:
  enum Type:
    case `system`
    case `app`
    case `snapshot`
...
end ListImages200ResponseImagesInnerEnums
