...
case class ListServers200ResponseServersInner(
    /* ID of the [Server](#tag/servers). */
    @named("id") id: Long,
    /* Name of the Server (must be unique per Project and a valid hostname as per RFC 1123). */
    @named("name") name: String,
    /* Status of the Server. */
    @named("status") status: ListServers200ResponseServersInnerEnums.Status,
    ...
    @named("public_net") publicNet: ListServers200ResponseServersInnerPublicNet,
    /* Private networks information. */
    @named("private_net") privateNet: Seq[
    ...
    @named(
      "datacenter"
    ) datacenter: ListServers200ResponseServersInnerDatacenter,
    @named("location") location: ListServers200ResponseServersInnerLocation,
    @named("image") image: ListServers200ResponseServersInnerImage,
    @named("iso") iso: ListServers200ResponseServersInnerIso,
    ...
    @named(
      "protection"
    ) protection: ListServers200ResponseServersInnerProtection,
    ...
    @named("primary_disk_size") primaryDiskSize: Double,
    ...
    @named("placement_group") placementGroup: Option[PlacementGroupNullable] =
      scala.None
)

object ListServers200ResponseServersInnerEnums:
  enum Status:
    case `running`
    case `initializing`
    case `starting`
...
end ListServers200ResponseServersInnerEnums
