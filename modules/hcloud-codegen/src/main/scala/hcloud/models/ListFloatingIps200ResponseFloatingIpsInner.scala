...
case class ListFloatingIps200ResponseFloatingIpsInner(
    ...
    @named("type") `type`: ListFloatingIps200ResponseFloatingIpsInnerEnums.Type,
    ...
    @named(
      "home_location"
    ) homeLocation: ListFloatingIps200ResponseFloatingIpsInnerHomeLocation,
...
object ListFloatingIps200ResponseFloatingIpsInnerEnums:
  enum Type:
    case `ipv4`
    case `ipv6`
...
end ListFloatingIps200ResponseFloatingIpsInnerEnums
