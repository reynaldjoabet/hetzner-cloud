...
case class GetPricing200ResponsePricingPrimaryIpsInner(
    /* Type of [Primary IP](#tag/primary-ips) the price is for. */
    @named(
      "type"
    ) `type`: GetPricing200ResponsePricingPrimaryIpsInnerEnums.Type,
...
object GetPricing200ResponsePricingPrimaryIpsInnerEnums:
  enum Type:
    case `ipv4`
    case `ipv6`
...
end GetPricing200ResponsePricingPrimaryIpsInnerEnums
