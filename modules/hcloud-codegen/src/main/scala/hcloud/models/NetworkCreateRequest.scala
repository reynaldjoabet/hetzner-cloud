...
case class NetworkCreateRequest(
    ...
    @named("subnets") subnets: Option[Seq[NetworkCreateRequestSubnetsInner]] =
      scala.None,
    /* Array of routes set in this [Network](#tag/networks). */
    @named("routes") routes: Option[
      Seq[ListNetworks200ResponseNetworksInnerRoutesInner]
    ] = scala.None,
