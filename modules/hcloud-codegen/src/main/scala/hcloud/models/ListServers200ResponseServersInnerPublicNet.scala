...
/** Public network information. The Server's IPv4 address can be found in
  * `public_net->ipv4->ip`.
  */
case class ListServers200ResponseServersInnerPublicNet(
    @named("ipv4") ipv4: ListServers200ResponseServersInnerPublicNetIpv4,
    @named("ipv6") ipv6: ListServers200ResponseServersInnerPublicNetIpv6,
