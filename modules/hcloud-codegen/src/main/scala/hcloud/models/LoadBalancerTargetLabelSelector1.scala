...
/** LoadBalancerTargetLabelSelector Configuration for label selector targets,
  * only valid and required if type is `label_selector`.
  */
case class LoadBalancerTargetLabelSelector1(
    /* Label selector. */
