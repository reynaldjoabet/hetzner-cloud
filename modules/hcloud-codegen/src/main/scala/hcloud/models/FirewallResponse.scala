...
case class FirewallResponse(
    /* ID of the [Firewall](#tag/firewalls). */
    @named("id") id: Long,
    /* Name of the [Firewall](#tag/firewalls).  Limited to a maximum of 128 characters.  Must be unique per Project.  */
    ...
    @named("applied_to") appliedTo: Seq[FirewallResponseAppliedToInner],
