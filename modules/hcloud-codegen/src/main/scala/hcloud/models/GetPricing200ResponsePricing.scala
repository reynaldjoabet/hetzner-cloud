...
case class GetPricing200ResponsePricing(
    ...
    @named("primary_ips") primaryIps: Seq[
    ...
    @named("floating_ips") floatingIps: Seq[
      GetPricing200ResponsePricingFloatingIpsInner
    ],
    @named("image") image: GetPricing200ResponsePricingImage,
    @named("volume") volume: GetPricing200ResponsePricingVolume,
    @named(
      "server_backup"
    ) serverBackup: GetPricing200ResponsePricingServerBackup,
    /* Price of Server per [type](#tag/server-types) and per [Location](#tag/locations). */
    @named("server_types") serverTypes: Seq[
    ...
    @named("load_balancer_types") loadBalancerTypes: Seq[
      GetPricing200ResponsePricingLoadBalancerTypesInner
    ],
    @named("floating_ip") floatingIp: GetPricing200ResponsePricingFloatingIp
)
