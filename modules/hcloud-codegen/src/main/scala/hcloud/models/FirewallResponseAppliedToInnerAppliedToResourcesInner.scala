...
case class FirewallResponseAppliedToInnerAppliedToResourcesInner(
    /* Type of resource. */
    @named("type") `type`: Option[
      FirewallResponseAppliedToInnerAppliedToResourcesInnerEnums.Type
    ] = scala.None,
    @named("server") server: Option[FirewallResponseAppliedToInnerServer] =
      scala.None
)

object FirewallResponseAppliedToInnerAppliedToResourcesInnerEnums:
  enum Type:
    case `server`
...
end FirewallResponseAppliedToInnerAppliedToResourcesInnerEnums
