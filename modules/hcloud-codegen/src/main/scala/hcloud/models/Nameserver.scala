...
case class Nameserver(
  ...
  @named("tsig_algorithm") tsigAlgorithm: Option[NameserverEnums.TsigAlgorithm] = scala.None,
...
object NameserverEnums:
  ...
  object TsigAlgorithm:
    ...
    given tsigAlgorithmCodec: JsonValueCodec[TsigAlgorithm] = JsonCodecMaker.make {
      CodecMakerConfig
