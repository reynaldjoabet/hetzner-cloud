...
case class PrimaryZoneAllOfAuthoritativeNameservers(
    ...
    @named("delegation_last_check") delegationLastCheck: OffsetDateTime,
    /* Status of the delegation.  */
    @named("delegation_status") delegationStatus: Option[
      PrimaryZoneAllOfAuthoritativeNameserversEnums.DelegationStatus
    ] = scala.None
)

object PrimaryZoneAllOfAuthoritativeNameserversEnums:
...
end PrimaryZoneAllOfAuthoritativeNameserversEnums
