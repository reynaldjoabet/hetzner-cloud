...
case class PrimaryZone(
    ...
    @named("status") status: PrimaryZoneEnums.Status,
    ...
    @named("registrar") registrar: PrimaryZoneEnums.Registrar,
    /* Mode of the [Zone](#tag/zones).  For more information, see [Zone Modes](#tag/zones/zone-modes).  */
    @named("mode") mode: PrimaryZoneEnums.Mode,
