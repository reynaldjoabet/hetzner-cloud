...
/** ISO Image that is attached to this Server. Null if no ISO is attached.
  */
case class ListServers200ResponseServersInnerIso(
    ...
    /* Type of the ISO. */
    @named("type") `type`: ListServers200ResponseServersInnerIsoEnums.Type,
    ...
    @named(
      "architecture"
    ) architecture: ListServers200ResponseServersInnerIsoEnums.Architecture
)

object ListServers200ResponseServersInnerIsoEnums:
  enum Type:
    case `public`
    case `private`
...
end ListServers200ResponseServersInnerIsoEnums
