...
case class ChangeLoadBalancerAlgorithmRequest(
    /* Algorithm of the Load Balancer. */
    @named("type") `type`: ChangeLoadBalancerAlgorithmRequestEnums.Type
)

object ChangeLoadBalancerAlgorithmRequestEnums:
  enum Type:
    case `round_robin`
...
end ChangeLoadBalancerAlgorithmRequestEnums
