...
case class FloatingIPCreateRequest(
    /* The Floating IP type. */
    @named("type") `type`: FloatingIPCreateRequestEnums.Type,
    ...
    @named("home_location") homeLocation: Option[
      FloatingIPCreateRequestHomeLocation
    ] = scala.None,
...
object FloatingIPCreateRequestEnums:
  enum Type:
    case `ipv4`
    case `ipv6`
...
end FloatingIPCreateRequestEnums
