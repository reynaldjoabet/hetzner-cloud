...
case class ZoneSecondary(
    ...
    @named("status") status: ZoneSecondaryEnums.Status,
    ...
    @named("registrar") registrar: ZoneSecondaryEnums.Registrar,
    /* Mode of the [Zone](#tag/zones).  For more information, see [Zone Modes](#tag/zones/zone-modes).  */
    @named("mode") mode: ZoneSecondaryEnums.Mode,
