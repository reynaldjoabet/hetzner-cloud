...
case class ZonePrimary(
    ...
    @named("status") status: ZonePrimaryEnums.Status,
    ...
    @named("registrar") registrar: ZonePrimaryEnums.Registrar,
    /* Mode of the [Zone](#tag/zones).  For more information, see [Zone Modes](#tag/zones/zone-modes).  */
    @named("mode") mode: ZonePrimaryEnums.Mode,
