...
/** Home [Location](#tag/locations) for the [Floating IP](#tag/floating-ips).
  * Either the ID or the name of the [Location](#tag/locations). Only optional
  * if no [Server](#tag/servers) is provided. Routing is optimized for this
  * [Locations](#tag/locations).
  */
case class FloatingIPCreateRequestHomeLocation(
)
