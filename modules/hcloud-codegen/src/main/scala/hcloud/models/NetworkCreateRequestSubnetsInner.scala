...
case class NetworkCreateRequestSubnetsInner(
    /* Type of subnet.  */
    @named("type") `type`: NetworkCreateRequestSubnetsInnerEnums.Type,
...
object NetworkCreateRequestSubnetsInnerEnums:
  enum Type:
    case `cloud`
    case `server`
    case `vswitch`
...
end NetworkCreateRequestSubnetsInnerEnums
