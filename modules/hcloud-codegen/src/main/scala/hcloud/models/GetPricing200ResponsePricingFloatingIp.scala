...
/** Price of [Floating IPs](#tag/floating-ips). **Deprecated**: This field is
  * deprecated, please refer to the `floating_ips` field instead. See the
  * [Changelog](https://docs.hetzner.cloud/changelog#2024-08-29-field-floating_ip-in-pricing-response-is-now-deprecated)
  * for more details.
  */
case class GetPricing200ResponsePricingFloatingIp(
    @named(
      "price_monthly"
    ) priceMonthly: GetPricing200ResponsePricingFloatingIpPriceMonthly
)
