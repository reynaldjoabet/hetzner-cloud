...
/** **Deprecated**: This property is deprecated and will be removed after 1 July
  * 2026. Use the `location` key instead. [Data Center](#tag/data-centers) ID or
  * name. The [Primary IP](#tag/primary-ips) will be bound to this [Data
  * Center](#tag/data-centers). Omit if `assignee_id`/`assignee_type` or
  * `location` are provided.
  */
case class PrimaryIPCreateRequestDatacenter(
)
