...
object ImageActions:
  ...
  ): ImageActions[hcloud.Authorization.NoAuthorization.type] =
    ImageActions(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(
      baseUrl: String,
      username: String,
      password: String
  ): ImageActions[hcloud.Authorization.BasicAuth] =
    ImageActions(baseUrl, hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(
      baseUrl: String,
      apiKey: String
  ): ImageActions[hcloud.Authorization.ApiKey] =
    ImageActions(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(
      baseUrl: String,
      token: String
  ): ImageActions[hcloud.Authorization.BearerToken] =
    ImageActions(baseUrl, hcloud.Authorization.BearerToken(token))

case class ImageActions[Auth <: hcloud.Authorization] private (
    baseUrl: String,
  ...
  /** Returns a specific Action for an Image.
    ...
    *   ID of the Action.
    */
  def getImageAction(id: Long, actionId: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ...
  /** Returns a specific Action object.
    ...
    *   ID of the Action.
    */
  def getImagesAction(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[Either[ResponseException[String], ActionResponse]] =
    val idPathParam =
      PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
