...
object ZoneRRSets:
  ...
  ): ZoneRRSets[hcloud.Authorization.NoAuthorization.type] =
    ZoneRRSets(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(
      baseUrl: String,
      username: String,
      password: String
  ): ZoneRRSets[hcloud.Authorization.BasicAuth] =
    ZoneRRSets(baseUrl, hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(
      baseUrl: String,
      apiKey: String
  ): ZoneRRSets[hcloud.Authorization.ApiKey] =
    ZoneRRSets(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(
      baseUrl: String,
      token: String
  ): ZoneRRSets[hcloud.Authorization.BearerToken] =
    ZoneRRSets(baseUrl, hcloud.Authorization.BearerToken(token))

case class ZoneRRSets[Auth <: hcloud.Authorization] private (
    baseUrl: String,
  ...
  /** Create an [RRSet](#tag/zone-rrsets) in the [Zone](#tag/zones). Only
    * applicable for [Zones](#tag/zones) in primary mode. #### Operation
    * specific errors | Status | Code | Description | | --- | --- | --- | |
    * `422` | `incorrect_zone_mode` | This operation is not supported for this
    * Zone's `mode`. |
    *
    * Expected answers: code 201 : CreateZoneRrset201Response (Request
  ...
  def createZoneRrset(
    ...
    Either[ResponseException[String], CreateZoneRrset201Response]
  ] =
  ...
  /** Deletes an [RRSet](#tag/zone-rrsets) from the [Zone](#tag/zones). Only
    * applicable for [Zones](#tag/zones) in primary mode. #### Operation
    * specific errors | Status | Code | Description | | --- | --- | --- | |
    * `422` | `incorrect_zone_mode` | This operation is not supported for this
    * Zone's `mode`. |
    *
    * Expected answers: code 201 : ActionResponse (Request succeeded.) code 4xx
    ...
    * @param rrType
    */
  def deleteZoneRrset(idOrName: String, rrName: String, rrType: String)(using
      Auth <:< hcloud.Authorization.BearerToken
  ...
  /** Returns a single [RRSet](#tag/zone-rrsets) from the [Zone](#tag/zones).
    ...
    * Zone's `mode`. |
    *
    * Expected answers: code 200 : GetZoneRrset200Response (Request succeeded.)
    ...
    * @param rrType
    */
  def getZoneRrset(idOrName: String, rrName: String, rrType: String)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
    Either[ResponseException[String], GetZoneRrset200Response]
  ] =
    val idOrNamePathParam = PathSerializable.serialize(
      "id_or_name",
      idOrName,
  ...
  /** Returns all [RRSets](#tag/zone-rrsets) in the [Zone](#tag/zones). Use the
    * provided URI parameters to modify the result. The maximum value for
    * `per_page` on this endpoint is `100` instead of `50`. Only applicable for
    ...
    * `mode`. |
    *
    * Expected answers: code 200 : ListZoneRrsets200Response (Request
    * succeeded.) code 4xx : GetActions4xxResponse (Request failed with a user
    * error.) code 5xx : GetActions5xxResponse (Request failed with a server
    * error.)
    *
    ...
    * @param `type`
    *   Filter resources by their type. May be used multiple times. The response
  ...
  def listZoneRrsets(
    ...
    Either[ResponseException[String], ListZoneRrsets200Response]
  ] =
    val idOrNamePathParam = PathSerializable.serialize(
      "id_or_name",
      idOrName,
  ...
  /** Updates an [RRSet](#tag/zone-rrsets) in the [Zone](#tag/zones). Only
    * applicable for [Zones](#tag/zones) in primary mode. #### Operation
    * specific errors | Status | Code | Description | | --- | --- | --- | |
    * `422` | `incorrect_zone_mode` | This operation is not supported for this
    * Zone's `mode`. |
