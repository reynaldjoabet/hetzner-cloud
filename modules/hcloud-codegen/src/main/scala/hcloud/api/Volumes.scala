...
import hcloud.models.CreateVolume201Response
...
import hcloud.models.GetVolume200Response
import hcloud.models.ListVolumes200Response
import hcloud.models.UpdateVolumeRequest
...
object Volumes:
  def apply(baseUrl: String = "https://api.hetzner.cloud/v1"): Volumes[hcloud.Authorization.NoAuthorization.type] = Volumes(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(baseUrl: String, username: String, password: String): Volumes[hcloud.Authorization.BasicAuth] =
    Volumes(baseUrl, hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(baseUrl: String, apiKey: String): Volumes[hcloud.Authorization.ApiKey] =
    Volumes(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(baseUrl: String, token: String): Volumes[hcloud.Authorization.BearerToken] =
    Volumes(baseUrl, hcloud.Authorization.BearerToken(token))

case class Volumes[Auth <: hcloud.Authorization] private (baseUrl: String, authConfig: hcloud.Authorization):
  def withBasicAuth(username: String, password: String): Volumes[hcloud.Authorization.BasicAuth] =
  ...
  def withBearerTokenAuth(token: String): Volumes[hcloud.Authorization.BearerToken] =
   ...
   * 
   * Expected answers:
   *   code 201 : CreateVolume201Response (Request succeeded.)
   ...
   */
  def createVolume(createVolumeRequest: CreateVolumeRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], CreateVolume201Response]] =
    val requestURL =
      uri"$baseUrl/volumes"
    ...
    basicRequest
      ...
      .response(asJson[CreateVolume201Response])

  /**
   * Deletes a volume. All Volume data is irreversibly destroyed. The Volume must not be attached to a Server and it must not have delete protection enabled. 
   * 
   * Expected answers:
   *   code 204 :  (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   */
  def deleteVolume(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], Unit]] =
   ...
   * 
   * Expected answers:
   *   code 200 : GetVolume200Response (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   * @param id ID of the Volume.
   */
  def getVolume(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetVolume200Response]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/volumes/${idPathParam}"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[GetVolume200Response])

  /**
   * Gets all existing Volumes that you have available. 
   * 
   * Expected answers:
   *   code 200 : ListVolumes200Response (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   */
  def listVolumes(status: Seq[String], sort: Seq[String], name: Option[String] = scala.None, labelSelector: Option[String] = scala.None, page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ListVolumes200Response]] =
    val requestURL =
      uri"$baseUrl/volumes"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[ListVolumes200Response])
   ...
   */
  def updateVolume(id: Long, updateVolumeRequest: UpdateVolumeRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetVolume200Response]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/volumes/${idPathParam}"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(updateVolumeRequest))
      .response(asJson[GetVolume200Response])
