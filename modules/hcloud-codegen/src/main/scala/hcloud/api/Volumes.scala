...
case class Volumes[Auth <: hcloud.Authorization] private (
  ...
  /** Creates a new Volume attached to a Server. If you want to create a Volume
    ...
    * be unique per Project. #### Operation specific errors | Status | Code |
    * Description | | --- | --- | --- | | `422` | `no_space_left_in_location` |
    * There is no volume space left in the given location |
    *
    * Expected answers: code 201 : CreateVolume201Response (Request succeeded.)
  ...
  def createVolume(createVolumeRequest: CreateVolumeRequest)(using
    ...
    Either[ResponseException[String], CreateVolume201Response]
  ] =
    val requestURL =
      uri"$baseUrl/volumes"
  ...
  /** Gets a specific Volume object.
    *
    * Expected answers: code 200 : GetVolume200Response (Request succeeded.)
    * code 4xx : GetActions4xxResponse (Request failed with a user error.) code
    * 5xx : GetActions5xxResponse (Request failed with a server error.)
    *
    * Available security schemes: APIToken (http)
  ...
  def getVolume(id: Long)(using
    ...
    Either[ResponseException[String], GetVolume200Response]
  ] =
    val idPathParam =
      PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
  ...
  /** Gets all existing Volumes that you have available.
    *
    * Expected answers: code 200 : ListVolumes200Response (Request succeeded.)
    * code 4xx : GetActions4xxResponse (Request failed with a user error.) code
    * 5xx : GetActions5xxResponse (Request failed with a server error.)
    *
    * Available security schemes: APIToken (http)
  ...
  def listVolumes(
    ...
    Either[ResponseException[String], ListVolumes200Response]
  ] =
    val requestURL =
      uri"$baseUrl/volumes"
        .addParams(
  ...
  /** Updates the Volume properties.
    ...
    */
  def updateVolume(id: Long, updateVolumeRequest: UpdateVolumeRequest)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
    Either[ResponseException[String], GetVolume200Response]
  ] =
