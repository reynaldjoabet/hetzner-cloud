...
import hcloud.models.CreateZone201Response
...
import hcloud.models.GetZone200Response
import hcloud.models.GetZoneZonefile200Response
import hcloud.models.ListZones200Response
import hcloud.models.ZoneUpdateRequest
...
object Zones:
  def apply(baseUrl: String = "https://api.hetzner.cloud/v1"): Zones[hcloud.Authorization.NoAuthorization.type] = Zones(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(baseUrl: String, username: String, password: String): Zones[hcloud.Authorization.BasicAuth] =
    Zones(baseUrl, hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(baseUrl: String, apiKey: String): Zones[hcloud.Authorization.ApiKey] =
    Zones(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(baseUrl: String, token: String): Zones[hcloud.Authorization.BearerToken] =
    Zones(baseUrl, hcloud.Authorization.BearerToken(token))

case class Zones[Auth <: hcloud.Authorization] private (baseUrl: String, authConfig: hcloud.Authorization):
  def withBasicAuth(username: String, password: String): Zones[hcloud.Authorization.BasicAuth] =
  ...
  def withBearerTokenAuth(token: String): Zones[hcloud.Authorization.BearerToken] =
   ...
   * 
   * Expected answers:
   *   code 201 : CreateZone201Response (Request succeeded.)
   ...
   */
  def createZone(createZoneRequest: CreateZoneRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], CreateZone201Response]] =
    val requestURL =
      uri"$baseUrl/zones"
    ...
    basicRequest
      ...
      .response(asJson[CreateZone201Response])
   ...
   */
  def deleteZone(idOrName: String)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ActionResponse]] =
   ...
   * 
   * Expected answers:
   *   code 200 : GetZone200Response (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   * @param idOrName ID or Name of the Zone.
   */
  def getZone(idOrName: String)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetZone200Response]] =
    val idOrNamePathParam = PathSerializable.serialize("id_or_name", idOrName, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/zones/${idOrNamePathParam}"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[GetZone200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetZoneZonefile200Response (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   * @param idOrName ID or Name of the Zone.
   */
  def getZoneZonefile(idOrName: String)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetZoneZonefile200Response]] =
    val idOrNamePathParam = PathSerializable.serialize("id_or_name", idOrName, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[GetZoneZonefile200Response])

  /**
   * Returns all [Zones](#tag/zones).  Use the provided URI parameters to modify the result. 
   * 
   * Expected answers:
   *   code 200 : ListZones200Response (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   */
  def listZones(name: Option[String] = scala.None, mode: Option[String] = scala.None, labelSelector: Option[String] = scala.None, sort: Seq[String], page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ListZones200Response]] =
    val requestURL =
      uri"$baseUrl/zones"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[ListZones200Response])
   ...
   * 
   * @param idOrName ID or Name of the Zone.
   * @param zoneUpdateRequest 
   */
  def updateZone(idOrName: String, zoneUpdateRequest: ZoneUpdateRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetZone200Response]] =
    val idOrNamePathParam = PathSerializable.serialize("id_or_name", idOrName, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/zones/${idOrNamePathParam}"
