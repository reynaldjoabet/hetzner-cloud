...
case class PrimaryIps[Auth <: hcloud.Authorization] private (baseUrl: String, authConfig: hcloud.Authorization):
   ...
   * 
   * Expected answers:
   *   code 201 : AssignPrimaryIpToResourceResponse (Response for assigning a Primary IP.  Contains an Action of type `assign_primary_ip`. )
   * 
   ...
   */
  def assignPrimaryIpToResource(id: Long, assignPrimaryIpToResourceRequest: AssignPrimaryIpToResourceRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], AssignPrimaryIpToResourceResponse]] =
   ...
   * 
   * Expected answers:
   *   code 201 : ChangePrimaryIpProtectionResponse (Response for changing a Primary IPs protection settings.  Contains an Action of type `change_protection`. )
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   * @param body 
   */
  def changePrimaryIpProtection(id: Long, body: Protection)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ChangePrimaryIpProtectionResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
   ...
   * 
   * Expected answers:
   *   code 201 : ChangeReverseDnsRecordsForPrimaryIpResponse (Response for changing a Primary IPs DNS pointer.  Contains an Action of type `change_dns_ptr`. )
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Primary IP.
   * @param body The `ip` attributes specifies for which IP address the record is set. For IPv4 addresses this must be the exact address of the Primary IP. For IPv6 addresses this must be a single address within the `/64` subnet of the Primary IP.  The `dns_ptr` attribute specifies the hostname used for the IP address. Must be a fully qualified domain name (FQDN) without trailing dot.  For IPv6 Primary IPs up to 100 entries can be created. 
   */
  def changeReverseDnsRecordsForPrimaryIp(id: Long, body: DnsPtr)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ChangeReverseDnsRecordsForPrimaryIpResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
   ...
   * 
   * Expected answers:
   *   code 201 : CreatePrimaryIpResponse (Response for creating a Primary IP.  Contains the newly created Primary IP. )
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param createPrimaryIpRequest Request Body for creating a new Primary IP.  The `datacenter` and `assignee_id`/`assignee_type` attributes are mutually exclusive. 
   */
  def createPrimaryIp(createPrimaryIpRequest: CreatePrimaryIpRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], CreatePrimaryIpResponse]] =
    val requestURL =
   ...
   * 
   * Expected answers:
   *   code 204 :  (Primary IP deletion succeeded.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   * 
   * Expected answers:
   *   code 200 : GetPrimaryIpResponse (The `primary_ip` key contains the Primary IP.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Primary IP.
   */
  def getPrimaryIp(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetPrimaryIpResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/primary_ips/${idPathParam}"
   ...
   */
  def getPrimaryIpAction(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetActionResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
   ...
   */
  def listPrimaryIpActions(id: Seq[Long], sort: Seq[String], status: Seq[String], page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ListActionsResponse]] =
    val requestURL =
   ...
   * 
   * Expected answers:
   *   code 200 : ListPrimaryIpsResponse (Response for listing Primary IPs.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def listPrimaryIps(name: Option[String] = scala.None, labelSelector: Option[String] = scala.None, ip: Option[String] = scala.None, page: Option[Long] = scala.None, perPage: Option[Long] = scala.None, sort: Seq[String])(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ListPrimaryIpsResponse]] =
    val requestURL =
      uri"$baseUrl/primary_ips"
   ...
   * 
   * Expected answers:
   *   code 200 : ReplacePrimaryIpResponse (The `primary_ip` key contains the updated Primary IP.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def replacePrimaryIp(id: Long, replacePrimaryIpRequest: ReplacePrimaryIpRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ReplacePrimaryIpResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/primary_ips/${idPathParam}"
   ...
   * 
   * Expected answers:
   *   code 201 : UnassignPrimaryIpFromResourceResponse (Response for unassigning a Primary IP.  Contains an Action of type `unassign_primary_ip`. )
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Primary IP.
   */
  def unassignPrimaryIpFromResource(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], UnassignPrimaryIpFromResourceResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
