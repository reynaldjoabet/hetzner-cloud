...
import hcloud.models.GetLoadBalancerType200Response
import hcloud.models.ListLoadBalancerTypes200Response
...
case class LoadBalancerTypes[Auth <: hcloud.Authorization] private (
  ...
  /** Gets a specific Load Balancer type object.
    *
    * Expected answers: code 200 : GetLoadBalancerType200Response (Request
  ...
  def getLoadBalancerType(id: Long)(using
    ...
    Either[ResponseException[String], GetLoadBalancerType200Response]
  ] =
    val idPathParam =
    ...
    basicRequest
      ...
      .auth(authConfig)
      .response(asJson[GetLoadBalancerType200Response])

  /** Gets all Load Balancer type objects.
    *
    * Expected answers: code 200 : ListLoadBalancerTypes200Response (Request
    * succeeded.) code 4xx : GetActions4xxResponse (Request failed with a user
    * error.) code 5xx : GetActions5xxResponse (Request failed with a server
    * error.)
    *
  ...
  def listLoadBalancerTypes(
    ...
    Either[ResponseException[String], ListLoadBalancerTypes200Response]
  ] =
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[ListLoadBalancerTypes200Response])
