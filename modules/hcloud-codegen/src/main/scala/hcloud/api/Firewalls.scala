...
object Firewalls:
  ...
  ): Firewalls[hcloud.Authorization.NoAuthorization.type] =
    Firewalls(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(
      baseUrl: String,
      username: String,
      password: String
  ): Firewalls[hcloud.Authorization.BasicAuth] =
    Firewalls(baseUrl, hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(
      baseUrl: String,
      apiKey: String
  ): Firewalls[hcloud.Authorization.ApiKey] =
    Firewalls(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(
      baseUrl: String,
      token: String
  ): Firewalls[hcloud.Authorization.BearerToken] =
    Firewalls(baseUrl, hcloud.Authorization.BearerToken(token))

case class Firewalls[Auth <: hcloud.Authorization] private (
    baseUrl: String,
  ...
  /** Create a [Firewall](#tag/firewalls). #### Operation specific errors |
    * Status | Code | Description | | --- | --- | --- | | `422` |
    * `server_already_added` | The [Server](#tag/servers) was applied more than
    * once. | | `422` | `incompatible_network_type` | The resources network type
    * is not supported by [Firewalls](#tag/firewalls). | | `422` |
    * `firewall_resource_not_found` | The resource the
    * [Firewall](#tag/firewalls) should be attached to was not found. |
    *
    * Expected answers: code 201 : CreateFirewallResponse (Request succeeded.)
    ...
    */
  def createFirewall(createFirewallRequest: CreateFirewallRequest)(using
  ...
  /** Deletes the [Firewall](#tag/firewalls). #### Operation specific errors |
    * Status | Code | Description | | --- | --- | --- | | `422` |
    * `resource_in_use` | [Firewall](#tag/firewalls) still applied to a resource |
    *
    ...
    *   ID of the Firewall.
    */
  def deleteFirewall(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ...
  /** Returns a single [Firewall](#tag/firewalls).
    *
    * Expected answers: code 200 : FirewallResponse1 (Request succeeded.) code
    ...
    *   ID of the Firewall.
    */
  def getFirewall(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
    Either[ResponseException[String], FirewallResponse1]
  ] =
    val idPathParam =
      PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
  ...
  /** Returns all [Firewalls](#tag/firewalls). Use the provided URI parameters
    * to modify the result.
    *
    * Expected answers: code 200 : FirewallsResponse (Request succeeded.) code
    * 4xx : GetActions4xxResponse (Request failed with a user error.) code 5xx :
    * GetActions5xxResponse (Request failed with a server error.)
    *
    * Available security schemes: APIToken (http)
  ...
  def listFirewalls(
    ...
    Either[ResponseException[String], FirewallsResponse]
  ] =
    val requestURL =
      uri"$baseUrl/firewalls"
        .addParams(
  ...
  /** Update a [Firewall](#tag/firewalls). In case of a parallel running change
    * on the [Firewall](#tag/firewalls) a `conflict` error will be returned.
    *
    * Expected answers: code 200 : FirewallResponse1 (Request succeeded.) code
    * 4xx : GetActions4xxResponse (Request failed with a user error.) code 5xx :
    * GetActions5xxResponse (Request failed with a server error.)
    ...
    */
  def updateFirewall(id: Long, updateFirewallRequest: UpdateFirewallRequest)(
