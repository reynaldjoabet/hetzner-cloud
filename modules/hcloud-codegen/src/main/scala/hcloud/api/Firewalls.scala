...
case class Firewalls[Auth <: hcloud.Authorization] private (
  ...
  /** Returns a specific Action for a Firewall.
    ...
    *   ID of the Action.
    */
  def getActionForFirewall(id: Long, actionId: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Returns the specific Action.
    ...
    *   ID of the Action.
    */
  def getFirewallAction(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
    Either[ResponseException[String], GetActionResponse]
  ] =
  ...
  /** Update a Firewall. In case of a parallel running change on the Firewall a
    ...
    */
  def replaceFirewall(id: Long, replaceFirewallRequest: ReplaceFirewallRequest)(
  ...
  /** Set the rules of a Firewall. Overwrites the existing rules with the given
    ...
    */
  def setRules(id: Long, setRulesRequest: SetRulesRequest)(using
      Auth <:< hcloud.Authorization.BearerToken
