...
import hcloud.models.FirewallResponse1
import hcloud.models.FirewallsResponse
import hcloud.models.GetActions4xxResponse
import hcloud.models.GetActions5xxResponse
import hcloud.models.UpdateFirewallRequest
...
case class Firewalls[Auth <: hcloud.Authorization] private (baseUrl: String, authConfig: hcloud.Authorization):
   ...
   * 
   * Expected answers:
   *   code 201 : CreateFirewallResponse (Request succeeded.)
   ...
   * 
   * Expected answers:
   *   code 200 : FirewallResponse1 (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   * @param id ID of the Firewall.
   */
  def getFirewall(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], FirewallResponse1]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/firewalls/${idPathParam}"
   ...
   */
  def listFirewalls(sort: Seq[String], name: Option[String] = scala.None, labelSelector: Option[String] = scala.None, page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], FirewallsResponse]] =
    val requestURL =
      uri"$baseUrl/firewalls"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[FirewallsResponse])
   ...
   * 
   * @param id ID of the Firewall.
   * @param updateFirewallRequest 
   */
  def updateFirewall(id: Long, updateFirewallRequest: UpdateFirewallRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], FirewallResponse1]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/firewalls/${idPathParam}"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(updateFirewallRequest))
      .response(asJson[FirewallResponse1])
