...
object CertificateActions:
  ...
  ): CertificateActions[hcloud.Authorization.NoAuthorization.type] =
    CertificateActions(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(
      baseUrl: String,
      username: String,
      password: String
  ): CertificateActions[hcloud.Authorization.BasicAuth] =
    CertificateActions(
      baseUrl,
  ...
  def withApiKeyAuth(
      baseUrl: String,
      apiKey: String
  ): CertificateActions[hcloud.Authorization.ApiKey] =
    CertificateActions(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(
      baseUrl: String,
      token: String
  ): CertificateActions[hcloud.Authorization.BearerToken] =
    CertificateActions(baseUrl, hcloud.Authorization.BearerToken(token))

case class CertificateActions[Auth <: hcloud.Authorization] private (
    baseUrl: String,
  ...
  /** Returns a specific Action for a Certificate. Only type `managed`
    ...
    *   ID of the Action.
    */
  def getCertificateAction(id: Long, actionId: Long)(using
  ...
  /** Returns a specific Action object.
    ...
    *   ID of the Action.
    */
  def getCertificatesAction(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[Either[ResponseException[String], ActionResponse]] =
    val idPathParam =
      PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
  ...
  /** Retry a failed Certificate issuance or renewal. Only applicable if the
    ...
    * `failed`. #### Operation specific errors | Status | Code | Description | |
    * --- | --- | --- | | | `caa_record_does_not_allow_ca` | CAA record does not
    * allow certificate authority | | | `ca_dns_validation_failed` | Certificate
    * Authority: DNS validation failed | | |
    * `ca_too_many_authorizations_failed_recently` | Certificate Authority: Too
    * many authorizations failed recently | | |
    ...
    * zone not found | | | `dns_zone_is_secondary_zone` | DNS zone is a
    * secondary zone |
    *
    ...
    *   ID of the Certificate.
    */
  def retryCertificate(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
