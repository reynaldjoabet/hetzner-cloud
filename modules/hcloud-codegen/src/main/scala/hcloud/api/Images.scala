...
case class Images[Auth <: hcloud.Authorization] private (baseUrl: String, authConfig: hcloud.Authorization):
   ...
   * 
   * Expected answers:
   *   code 201 : ChangeImageProtectionResponse (The `action` key contains the `change_protection` Action.)
   * 
   ...
   */
  def changeImageProtection(id: Long, changeImageProtectionRequest: ChangeImageProtectionRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ChangeImageProtectionResponse]] =
   ...
   * 
   * Expected answers:
   *   code 200 : GetActionResponse (The `action` key contains the Image Action.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def getActionForImage(id: Long, actionId: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetActionResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
   ...
   * 
   * Expected answers:
   *   code 200 : GetImageResponse (The `image` key in the reply contains an Image object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Image.
   */
  def getImage(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetImageResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/images/${idPathParam}"
   ...
   */
  def getImageAction(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetActionResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
   ...
   */
  def listActionsForImage(id: Long, sort: Seq[String], status: Seq[String], page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ListActionsResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
   ...
   * @param perPage Maximum number of entries returned per page. For more information, see \"Pagination\".
   */
  def listImageActions(id: Seq[Long], sort: Seq[String], status: Seq[String], page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ListActionsResponse]] =
    val requestURL =
   ...
   * 
   * Expected answers:
   *   code 200 : ListImagesResponse (The `images` key in the reply contains an array of Image objects with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   * 
   * Expected answers:
   *   code 200 : ReplaceImageResponse (The image key in the reply contains the modified Image object.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def replaceImage(id: Long, replaceImageRequest: ReplaceImageRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ReplaceImageResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/images/${idPathParam}"
