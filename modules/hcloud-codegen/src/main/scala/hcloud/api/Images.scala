...
case class Images[Auth <: hcloud.Authorization] private (
  ...
  /** Returns a specific Image object.
    *
    * Expected answers: code 200 : GetImage200Response (Request succeeded.) code
  ...
  def getImage(id: Long)(using
    ...
    Either[ResponseException[String], GetImage200Response]
  ] =
    val idPathParam =
      PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
  ...
  /** Returns all Image objects. You can select specific Image types only and
    ...
    *
    * Expected answers: code 200 : ListImages200Response (Request succeeded.)
  ...
  def listImages(
    ...
    Either[ResponseException[String], ListImages200Response]
  ] =
    val requestURL =
      uri"$baseUrl/images"
        .addParams(
  ...
  /** Updates the Image. You may change the description, convert a Backup Image
    ...
    */
  def updateImage(id: Long, updateImageRequest: UpdateImageRequest)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
    Either[ResponseException[String], GetImage200Response]
  ] =
