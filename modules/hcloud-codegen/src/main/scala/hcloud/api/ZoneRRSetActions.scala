...
object ZoneRRSetActions:
  def apply(baseUrl: String = "https://api.hetzner.cloud/v1"): ZoneRRSetActions[hcloud.Authorization.NoAuthorization.type] = ZoneRRSetActions(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(baseUrl: String, username: String, password: String): ZoneRRSetActions[hcloud.Authorization.BasicAuth] =
    ZoneRRSetActions(baseUrl, hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(baseUrl: String, apiKey: String): ZoneRRSetActions[hcloud.Authorization.ApiKey] =
    ZoneRRSetActions(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(baseUrl: String, token: String): ZoneRRSetActions[hcloud.Authorization.BearerToken] =
    ZoneRRSetActions(baseUrl, hcloud.Authorization.BearerToken(token))

case class ZoneRRSetActions[Auth <: hcloud.Authorization] private (baseUrl: String, authConfig: hcloud.Authorization):
  def withBasicAuth(username: String, password: String): ZoneRRSetActions[hcloud.Authorization.BasicAuth] =
    copy(authConfig = hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(apiKey: String): ZoneRRSetActions[hcloud.Authorization.ApiKey] =
  ...
  def withBearerTokenAuth(token: String): ZoneRRSetActions[hcloud.Authorization.BearerToken] =
