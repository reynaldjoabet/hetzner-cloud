...
import hcloud.models.CreateSshKey201Response
...
import hcloud.models.ListSshKeys200Response
import hcloud.models.UpdateSshKeyRequest
...
object SSHKeys:
  def apply(baseUrl: String = "https://api.hetzner.cloud/v1"): SSHKeys[hcloud.Authorization.NoAuthorization.type] = SSHKeys(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(baseUrl: String, username: String, password: String): SSHKeys[hcloud.Authorization.BasicAuth] =
    SSHKeys(baseUrl, hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(baseUrl: String, apiKey: String): SSHKeys[hcloud.Authorization.ApiKey] =
    SSHKeys(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(baseUrl: String, token: String): SSHKeys[hcloud.Authorization.BearerToken] =
    SSHKeys(baseUrl, hcloud.Authorization.BearerToken(token))

case class SSHKeys[Auth <: hcloud.Authorization] private (baseUrl: String, authConfig: hcloud.Authorization):
  def withBasicAuth(username: String, password: String): SSHKeys[hcloud.Authorization.BasicAuth] =
  ...
  def withBearerTokenAuth(token: String): SSHKeys[hcloud.Authorization.BearerToken] =
   ...
   * 
   * Expected answers:
   *   code 201 : CreateSshKey201Response (Request succeeded.)
   ...
   */
  def createSshKey(createSshKeyRequest: CreateSshKeyRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], CreateSshKey201Response]] =
    val requestURL =
    ...
    basicRequest
      ...
      .response(asJson[CreateSshKey201Response])
   ...
   */
  def deleteSshKey(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], Unit]] =
   ...
   * 
   * Expected answers:
   *   code 200 : CreateSshKey201Response (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   * @param id ID of the SSH Key.
   */
  def getSshKey(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], CreateSshKey201Response]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/ssh_keys/${idPathParam}"
   ...
   * 
   * Expected answers:
   *   code 200 : ListSshKeys200Response (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   */
  def listSshKeys(sort: Seq[String], name: Option[String] = scala.None, fingerprint: Option[String] = scala.None, labelSelector: Option[String] = scala.None, page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ListSshKeys200Response]] =
    val requestURL =
      uri"$baseUrl/ssh_keys"
        ...
        .addParams(FormSerializable.serialize("fingerprint", fingerprint, FormStyleFormat.FORM, true): _*)
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[ListSshKeys200Response])
   ...
   */
  def updateSshKey(id: Long, updateSshKeyRequest: UpdateSshKeyRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], CreateSshKey201Response]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/ssh_keys/${idPathParam}"
