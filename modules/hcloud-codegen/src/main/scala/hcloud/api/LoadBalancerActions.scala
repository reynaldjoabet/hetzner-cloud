...
import hcloud.models.ChangeLoadbalancerDnsPtrRequest
import hcloud.models.ChangeTypeRequest
import hcloud.models.DeleteLoadBalancerServiceRequest
...
import hcloud.models.LoadBalancerTarget1
...
object LoadBalancerActions:
  def apply(
      baseUrl: String = "https://api.hetzner.cloud/v1"
  ): LoadBalancerActions[hcloud.Authorization.NoAuthorization.type] =
    LoadBalancerActions(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(
      baseUrl: String,
      username: String,
      password: String
  ): LoadBalancerActions[hcloud.Authorization.BasicAuth] =
    LoadBalancerActions(
      baseUrl,
  ...
  def withApiKeyAuth(
      baseUrl: String,
      apiKey: String
  ): LoadBalancerActions[hcloud.Authorization.ApiKey] =
    LoadBalancerActions(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(
      baseUrl: String,
      token: String
  ): LoadBalancerActions[hcloud.Authorization.BearerToken] =
    LoadBalancerActions(baseUrl, hcloud.Authorization.BearerToken(token))

case class LoadBalancerActions[Auth <: hcloud.Authorization] private (
    baseUrl: String,
  ...
  /** Adds a service to a Load Balancer. #### Operation specific errors | Status |
    * Code | Description | | --- | --- | --- | | `412` |
  ...
  /** Adds a target to a Load Balancer. #### Operation specific errors | Status |
    * Code | Description | | --- | --- | --- | | `422` |
    * `ip_not_in_vswitch_subnet` | The IP you are trying to add does not belong
    * to the vswitch subnet of the attached network | | `422` | `ip_not_owned` |
    * The IP you are trying to add as a target is not owned by the Project owner | |
    * `422` | `load_balancer_public_interface_disabled` | The Load Balancer's
    * public network interface is disabled | | `422` |
    * `load_balancer_not_attached_to_network` | The Load Balancer is not
    * attached to a network | | `422` | `network_has_no_vswitch_subnet` | The
    * given IP is private but attached network does not have a vswitch subnet | |
    * `422` | `resolve_cloud_private_targets_error` | The server you are trying
    * to add as a target is not attached to the same network as the Load
    * Balancer | | `422` | `resolve_cloud_public_targets_error` | The server
    * that you are trying to add as a public target does not have a public IPv4
    * address | | `422` | `target_already_defined` | The Load Balancer target
    * you are trying to define is already defined |
    *
    * Expected answers: code 201 : ActionResponse1 (Request succeeded.) code 4xx
    * : GetActions4xxResponse (Request failed with a user error.) code 5xx :
    * GetActions5xxResponse (Request failed with a server error.)
    ...
    */
  def addLoadBalancerTarget(id: Long, loadBalancerTarget1: LoadBalancerTarget1)(
  ...
  /** Attach a Load Balancer to a Network. #### Operation specific errors |
    * Status | Code | Description | | --- | --- | --- | | `422` |
    * `load_balancer_already_attached` | The Load Balancer is already attached
    * to a network | | `422` | `ip_not_available` | The provided Network IP is
    * not available | | `422` | `no_subnet_available` | No Subnet or IP is
    * available for the Load Balancer within the network |
    *
    * Expected answers: code 201 : ActionResponse1 (Request succeeded.) code 4xx
    * : GetActions4xxResponse (Request failed with a user error.) code 5xx :
    * GetActions5xxResponse (Request failed with a server error.)
  ...
  /** Change the algorithm that determines to which target new requests are
    ...
    */
  def changeLoadBalancerAlgorithm(
      id: Long,
  ...
  /** Changes the hostname that will appear when getting the hostname belonging
    ...
    * @param id
    *   ID of the Load Balancer.
    * @param changeLoadbalancerDnsPtrRequest
    ...
    *   trailing dot.
    */
  def changeLoadBalancerDnsPtr(
      id: Long,
      changeLoadbalancerDnsPtrRequest: ChangeLoadbalancerDnsPtrRequest
  )(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[Either[ResponseException[String], ActionResponse1]] =
    val idPathParam =
  ...
  /** Changes the type (Max Services, Max Targets and Max Connections) of a Load
    * Balancer. #### Operation specific errors | Status | Code | Description | |
    * --- | --- | --- | | `422` | `invalid_load_balancer_type` | The Load
    * Balancer type does not fit for the given Load Balancer |
    *
    * Expected answers: code 201 : ActionResponse1 (Request succeeded.) code 4xx
    * : GetActions4xxResponse (Request failed with a user error.) code 5xx :
    * GetActions5xxResponse (Request failed with a server error.)
    ...
    */
  def changeLoadBalancerType(id: Long, changeTypeRequest: ChangeTypeRequest)(
      using Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[Either[ResponseException[String], ActionResponse1]] =
    val idPathParam =
      PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
  ...
  /** Disable the public interface of a Load Balancer. The Load Balancer will be
    * not accessible from the internet via its public IPs. #### Operation
    * specific errors | Status | Code | Description | | --- | --- | --- | |
    * `422` | `load_balancer_not_attached_to_network` | The Load Balancer is not
    * attached to a network | | `422` | `targets_without_use_private_ip` | The
    * Load Balancer has targets that use the public IP instead of the private IP |
    *
    * Expected answers: code 201 : ActionResponse1 (Request succeeded.) code 4xx
    * : GetActions4xxResponse (Request failed with a user error.) code 5xx :
    * GetActions5xxResponse (Request failed with a server error.)
    ...
    *   ID of the Load Balancer.
    */
  def disableLoadBalancerPublicInterface(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[Either[ResponseException[String], ActionResponse1]] =
    val idPathParam =
      PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
  ...
  /** Enable the public interface of a Load Balancer. The Load Balancer will be
    ...
    *   ID of the Load Balancer.
    */
  def enableLoadBalancerPublicInterface(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[Either[ResponseException[String], ActionResponse1]] =
    val idPathParam =
      PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
  ...
  /** Returns a specific Action for a Load Balancer.
    ...
    *   ID of the Action.
    */
  def getLoadBalancerAction(id: Long, actionId: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ...
  /** Returns a specific Action object.
    ...
    *   ID of the Action.
    */
  def getLoadBalancersAction(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[Either[ResponseException[String], ActionResponse]] =
    val idPathParam =
      PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
  ...
  /** Updates a Load Balancer Service. #### Operation specific errors | Status |
    * Code | Description | | --- | --- | --- | | `422` |
    * `source_port_already_used` | The source port you are trying to add is
    * already in use |
    *
