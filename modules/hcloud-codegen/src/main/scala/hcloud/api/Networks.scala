...
import hcloud.models.CreateNetwork201Response
import hcloud.models.GetActions4xxResponse
import hcloud.models.GetActions5xxResponse
import hcloud.models.ListNetworks200Response
import hcloud.models.NetworkCreateRequest
import hcloud.models.NetworkUpdateRequest
...
object Networks:
  def apply(baseUrl: String = "https://api.hetzner.cloud/v1"): Networks[hcloud.Authorization.NoAuthorization.type] = Networks(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(baseUrl: String, username: String, password: String): Networks[hcloud.Authorization.BasicAuth] =
    Networks(baseUrl, hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(baseUrl: String, apiKey: String): Networks[hcloud.Authorization.ApiKey] =
    Networks(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(baseUrl: String, token: String): Networks[hcloud.Authorization.BearerToken] =
    Networks(baseUrl, hcloud.Authorization.BearerToken(token))

case class Networks[Auth <: hcloud.Authorization] private (baseUrl: String, authConfig: hcloud.Authorization):
  def withBasicAuth(username: String, password: String): Networks[hcloud.Authorization.BasicAuth] =
  ...
  def withBearerTokenAuth(token: String): Networks[hcloud.Authorization.BearerToken] =
   ...
   * 
   * Expected answers:
   *   code 201 : CreateNetwork201Response (Request succeeded.)
   ...
   *   APIToken (http)
   * 
   * @param networkCreateRequest 
   */
  def createNetwork(networkCreateRequest: NetworkCreateRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], CreateNetwork201Response]] =
    val requestURL =
    ...
    basicRequest
      ...
      .auth(authConfig)
      .body(asJson(networkCreateRequest))
      .response(asJson[CreateNetwork201Response])
   ...
   */
  def deleteNetwork(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], Unit]] =
   ...
   * 
   * Expected answers:
   *   code 200 : CreateNetwork201Response (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   * @param id ID of the Network.
   */
  def getNetwork(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], CreateNetwork201Response]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/networks/${idPathParam}"
   ...
   * 
   * Expected answers:
   *   code 200 : ListNetworks200Response (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   */
  def listNetworks(sort: Seq[String], name: Option[String] = scala.None, labelSelector: Option[String] = scala.None, page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ListNetworks200Response]] =
    val requestURL =
      uri"$baseUrl/networks"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[ListNetworks200Response])
   ...
   * 
   * @param id ID of the Network.
   * @param networkUpdateRequest 
   */
  def updateNetwork(id: Long, networkUpdateRequest: NetworkUpdateRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], CreateNetwork201Response]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/networks/${idPathParam}"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(networkUpdateRequest))
      .response(asJson[CreateNetwork201Response])
