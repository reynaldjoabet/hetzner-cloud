...
import hcloud.models.GetLocation200Response
import hcloud.models.ListLocations200Response
...
case class Locations[Auth <: hcloud.Authorization] private (
  ...
  /** Returns a [Location](#tag/locations).
    *
    * Expected answers: code 200 : GetLocation200Response (Request succeeded.)
  ...
  def getLocation(id: Long)(using
    ...
    Either[ResponseException[String], GetLocation200Response]
  ] =
    val idPathParam =
    ...
    basicRequest
      ...
      .auth(authConfig)
      .response(asJson[GetLocation200Response])

  /** Returns all [Locations](#tag/locations).
    *
    * Expected answers: code 200 : ListLocations200Response (Request succeeded.)
    * code 4xx : GetActions4xxResponse (Request failed with a user error.) code
    * 5xx : GetActions5xxResponse (Request failed with a server error.)
    *
    * Available security schemes: APIToken (http)
  ...
  def listLocations(
    ...
    Either[ResponseException[String], ListLocations200Response]
  ] =
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[ListLocations200Response])
