...
import hcloud.models.GetDatacenter200Response
import hcloud.models.ListDatacenters200Response
...
case class DataCenters[Auth <: hcloud.Authorization] private (
  ...
  /** Returns a single [Data Center](#tag/data-centers).
    *
    * Expected answers: code 200 : GetDatacenter200Response (Request succeeded.)
  ...
  def getDatacenter(id: Long)(using
    ...
    Either[ResponseException[String], GetDatacenter200Response]
  ] =
    val idPathParam =
    ...
    basicRequest
      ...
      .auth(authConfig)
      .response(asJson[GetDatacenter200Response])

  /** Returns all [Data Centers](#tag/data-centers).
    *
    * Expected answers: code 200 : ListDatacenters200Response (Request
  ...
  def listDatacenters(
    ...
    Either[ResponseException[String], ListDatacenters200Response]
  ] =
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[ListDatacenters200Response])
