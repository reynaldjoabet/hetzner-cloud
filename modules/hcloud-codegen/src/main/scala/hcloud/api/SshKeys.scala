...
case class SSHKeys[Auth <: hcloud.Authorization] private (
  ...
  /** Creates a new SSH key with the given `name` and `public_key`. Once an SSH
    ...
    *
    * Expected answers: code 201 : CreateSshKey201Response (Request succeeded.)
  ...
  def createSshKey(createSshKeyRequest: CreateSshKeyRequest)(using
    ...
    Either[ResponseException[String], CreateSshKey201Response]
  ] =
    val requestURL =
  ...
  /** Returns a specific SSH key object.
    *
    * Expected answers: code 200 : CreateSshKey201Response (Request succeeded.)
    * code 4xx : GetActions4xxResponse (Request failed with a user error.) code
    * 5xx : GetActions5xxResponse (Request failed with a server error.)
    *
    * Available security schemes: APIToken (http)
  ...
  /** Returns all SSH key objects.
    *
    * Expected answers: code 200 : ListSshKeys200Response (Request succeeded.)
    * code 4xx : GetActions4xxResponse (Request failed with a user error.) code
    * 5xx : GetActions5xxResponse (Request failed with a server error.)
    *
    * Available security schemes: APIToken (http)
    ...
    * @param fingerprint
    *   May be used to filter SSH keys by their fingerprint. The response will
  ...
  def listSshKeys(
    ...
    Either[ResponseException[String], ListSshKeys200Response]
  ] =
    val requestURL =
      uri"$baseUrl/ssh_keys"
        .addParams(
  ...
  /** Updates an SSH key. You can update an SSH key name and an SSH key labels.
    ...
    */
  def updateSshKey(id: Long, updateSshKeyRequest: UpdateSshKeyRequest)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
    Either[ResponseException[String], CreateSshKey201Response]
  ] =
