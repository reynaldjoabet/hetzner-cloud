...
object Certificates:
  ...
  ): Certificates[hcloud.Authorization.NoAuthorization.type] =
    Certificates(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(
      baseUrl: String,
      username: String,
      password: String
  ): Certificates[hcloud.Authorization.BasicAuth] =
    Certificates(baseUrl, hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(
      baseUrl: String,
      apiKey: String
  ): Certificates[hcloud.Authorization.ApiKey] =
    Certificates(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(
      baseUrl: String,
      token: String
  ): Certificates[hcloud.Authorization.BearerToken] =
    Certificates(baseUrl, hcloud.Authorization.BearerToken(token))

case class Certificates[Auth <: hcloud.Authorization] private (
    baseUrl: String,
  ...
  /** Creates a new Certificate. The default type **uploaded** allows for
    ...
    *
    * Expected answers: code 201 : CreateCertificateResponse (Request
    ...
    */
  def createCertificate(createCertificateRequest: CreateCertificateRequest)(
  ...
  /** Deletes a Certificate.
    ...
    */
  def deleteCertificate(id: Long)(using
  ...
  /** Gets a specific Certificate object.
    *
    * Expected answers: code 200 : CertificateResponse (Request succeeded.) code
    ...
    *   ID of the Certificate.
    */
  def getCertificate(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
    Either[ResponseException[String], CertificateResponse]
  ] =
    val idPathParam =
      PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
  ...
  /** Returns all Certificate objects.
    *
    * Expected answers: code 200 : CertificatesResponse (Request succeeded.)
  ...
  def listCertificates(
    ...
    Either[ResponseException[String], CertificatesResponse]
  ] =
    val requestURL =
      uri"$baseUrl/certificates"
        .addParams(
