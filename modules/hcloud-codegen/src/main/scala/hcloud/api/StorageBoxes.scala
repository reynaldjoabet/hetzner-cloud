...
object StorageBoxes:
  ...
  ): StorageBoxes[hcloud.Authorization.NoAuthorization.type] =
    StorageBoxes(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(
      baseUrl: String,
      username: String,
      password: String
  ): StorageBoxes[hcloud.Authorization.BasicAuth] =
    StorageBoxes(baseUrl, hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(
      baseUrl: String,
      apiKey: String
  ): StorageBoxes[hcloud.Authorization.ApiKey] =
    StorageBoxes(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(
      baseUrl: String,
      token: String
  ): StorageBoxes[hcloud.Authorization.BearerToken] =
    StorageBoxes(baseUrl, hcloud.Authorization.BearerToken(token))

case class StorageBoxes[Auth <: hcloud.Authorization] private (
    baseUrl: String,
  ...
  def changeHomeDirectory(
    ...
    val subaccountIdPathParam = PathSerializable.serialize(
      "subaccount_id",
      subaccountId,
  ...
  /** Changes the type of a Storage Box. Upgrades or downgrades a Storage Box to
    ...
    */
  def changeType(id: Long, changeTypeRequest: ChangeTypeRequest)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Creates a Storage Box Snapshot.
    ...
    */
  def createSnapshot(id: Long, createSnapshotRequest: CreateSnapshotRequest)(
  ...
  /** Creates a Storage Box.
    ...
    */
  def createStorageBox(createStorageBoxRequest: CreateStorageBoxRequest)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Deletes a Storage Box Snapshot.
    ...
    */
  def deleteSnapshot(id: Long, snapshotId: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
    ...
    val idPathParam =
      PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val snapshotIdPathParam = PathSerializable.serialize(
      "snapshot_id",
      snapshotId,
      PathStyleFormat.SIMPLE,
      false
  ...
  /** Deletes a Storage Box.
    ...
    *   ID of the Storage Box.
    */
  def deleteStorageBox(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Deletes a Storage Box Subaccount.
    ...
    *   ID of the Storage Box Subaccount.
    */
  def deleteSubaccount(id: Long, subaccountId: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Disables the active Snapshot Plan of a Storage Box. Existing Storage Box
    ...
    *   ID of the Storage Box.
    */
  def disableSnapshotPlan(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Returns a specific Action object for a Storage Box.
    ...
    *   ID of the Action.
    */
  def getActionForStorageBox(id: Long, actionId: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Returns a specific Storage Box Snapshot.
    ...
    *   ID of the Storage Box Snapshot.
    */
  def getSnapshot(id: Long, snapshotId: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Returns a specific Storage Box.
    ...
    *   ID of the Storage Box.
    */
  def getStorageBox(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Returns a specific Action object.
    ...
    *   ID of the Action.
    */
  def getStorageBoxAction(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
    Either[ResponseException[String], GetActionResponse]
  ] =
  ...
  /** Returns a specific Storage Box Subaccount.
    ...
    *   ID of the Storage Box Subaccount.
    */
  def getSubaccount(id: Long, subaccountId: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Returns a list of (sub)folders in a Storage Box. The folder location is
    ...
    */
  def listFoldersOfStorageBox(id: Long, path: Option[String] = scala.None)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  def listSubaccounts(
    ...
    val requestURL =
      uri"$baseUrl/storage_boxes/${idPathParam}/subaccounts"
        ...
        .addParams(
          FormSerializable
            .serialize("username", username, FormStyleFormat.FORM, true): _*
        )
