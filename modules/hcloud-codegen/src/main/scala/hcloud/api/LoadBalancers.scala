...
case class LoadBalancers[Auth <: hcloud.Authorization] private (
  ...
  /** Adds a service to a Load Balancer. #### Call specific error codes | Code |
    ...
    * @param body
    */
  def addService(id: Long, body: LoadBalancerService)(using
  ...
  /** Adds a target to a Load Balancer. #### Call specific error codes | Code |
    ...
    * @param body
    */
  def addTarget(id: Long, body: LoadBalancerAddTarget)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Change the algorithm that determines to which target new requests are
    ...
    * @param body
    */
  def changeAlgorithm(id: Long, body: LoadBalancerAlgorithm)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Delete a service of a Load Balancer.
    ...
    */
  def deleteService(id: Long, deleteServiceRequest: DeleteServiceRequest)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Disable the public interface of a Load Balancer. The Load Balancer will be
    ...
    *   ID of the Load Balancer.
    */
  def disablePublicInterfaceOfLoadBalancer(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[Either[ResponseException[
    String
  ...
  /** Enable the public interface of a Load Balancer. The Load Balancer will be
    ...
    *   ID of the Load Balancer.
    */
  def enablePublicInterfaceOfLoadBalancer(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[Either[ResponseException[
    String
  ...
  /** Returns a specific Action for a Load Balancer.
    ...
    *   ID of the Action.
    */
  def getActionForLoadBalancer(id: Long, actionId: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Returns a specific Action object.
    ...
    *   ID of the Action.
    */
  def getLoadBalancerAction(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
    Either[ResponseException[String], GetActionResponse]
  ] =
  ...
  /** Removes a target from a Load Balancer.
    ...
    */
  def removeTarget(id: Long, removeTargetRequest: RemoveTargetRequest)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Updates a Load Balancer Service. #### Call specific error codes | Code |
    ...
    * @param body
    */
  def updateService(id: Long, body: UpdateLoadBalancerService)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
