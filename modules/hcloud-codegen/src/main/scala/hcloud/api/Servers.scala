...
import hcloud.models.DeleteServer200Response
import hcloud.models.GetActions4xxResponse
import hcloud.models.GetActions5xxResponse
import hcloud.models.GetLoadBalancerMetrics200Response
import hcloud.models.GetServer200Response
import hcloud.models.ListServers200Response
import hcloud.models.UpdateServerRequest
...
object Servers:
  def apply(baseUrl: String = "https://api.hetzner.cloud/v1"): Servers[hcloud.Authorization.NoAuthorization.type] = Servers(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(baseUrl: String, username: String, password: String): Servers[hcloud.Authorization.BasicAuth] =
    Servers(baseUrl, hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(baseUrl: String, apiKey: String): Servers[hcloud.Authorization.ApiKey] =
    Servers(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(baseUrl: String, token: String): Servers[hcloud.Authorization.BearerToken] =
    Servers(baseUrl, hcloud.Authorization.BearerToken(token))

case class Servers[Auth <: hcloud.Authorization] private (baseUrl: String, authConfig: hcloud.Authorization):
  def withBasicAuth(username: String, password: String): Servers[hcloud.Authorization.BasicAuth] =
    copy(authConfig = hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(apiKey: String): Servers[hcloud.Authorization.ApiKey] =
    copy(authConfig = hcloud.Authorization.ApiKey(apiKey))

  def withNoAuth: Servers[hcloud.Authorization.NoAuthorization.type] =
    copy(authConfig = hcloud.Authorization.NoAuthorization)

  def withBearerTokenAuth(token: String): Servers[hcloud.Authorization.BearerToken] =
   ...
   * 
   * Expected answers:
   *   code 201 : CreateServerResponse (Request succeeded.)
   ...
   */
  def createServer(createServerRequest: CreateServerRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], CreateServerResponse]] =
    val requestURL =
      uri"$baseUrl/servers"
   ...
   * 
   * Expected answers:
   *   code 200 : DeleteServer200Response (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   */
  def deleteServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], DeleteServer200Response]] =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[DeleteServer200Response])

  /**
   * Returns a specific Server object. The Server must exist inside the Project. 
   * 
   * Expected answers:
   *   code 200 : GetServer200Response (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   * @param id ID of the Server.
   */
  def getServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetServer200Response]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/servers/${idPathParam}"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[GetServer200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetLoadBalancerMetrics200Response (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   */
  def getServerMetrics(id: Long, `type`: Seq[String], start: String, end: String, step: Option[String] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetLoadBalancerMetrics200Response]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/servers/${idPathParam}/metrics"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[GetLoadBalancerMetrics200Response])

  /**
   * Returns all existing Server objects. 
   * 
   * Expected answers:
   *   code 200 : ListServers200Response (Request succeeded.)
   *              Headers :
   ...
   * @param status Filter resources by status. May be used multiple times.  The response will only contain the resources with the specified status. 
   ...
   */
  def listServers(name: Option[String] = scala.None, labelSelector: Option[String] = scala.None, sort: Seq[String], status: Seq[String], page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ListServers200Response]] =
    val requestURL =
      uri"$baseUrl/servers"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[ListServers200Response])
   ...
   */
  def updateServer(id: Long, updateServerRequest: UpdateServerRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetServer200Response]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/servers/${idPathParam}"
