...
case class Servers[Auth <: hcloud.Authorization] private (baseUrl: String, authConfig: hcloud.Authorization):
   ...
   * 
   * Expected answers:
   *   code 201 : AddServerToPlacementGroupResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   ...
   */
  def addServerToPlacementGroup(id: Long, addServerToPlacementGroupRequest: AddServerToPlacementGroupRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], AddServerToPlacementGroupResponse]] =
    ...
    basicRequest
      ...
      .auth(authConfig)
      .body(asJson(addServerToPlacementGroupRequest))
      .response(asJson[AddServerToPlacementGroupResponse])
   ...
   * 
   * Expected answers:
   *   code 201 : AttachIsoToServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def attachIsoToServer(id: Long, attachIsoToServerRequest: AttachIsoToServerRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], AttachIsoToServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(attachIsoToServerRequest))
      .response(asJson[AttachIsoToServerResponse])
   ...
   * 
   * Expected answers:
   *   code 201 : AttachServerToNetworkResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def attachServerToNetwork(id: Long, attachServerToNetworkRequest: AttachServerToNetworkRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], AttachServerToNetworkResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(attachServerToNetworkRequest))
      .response(asJson[AttachServerToNetworkResponse])

  /**
   * Changes the alias IPs of an already attached Network. Note that the existing aliases for the specified Network will be replaced with these provided in the request body. So if you want to add an alias IP, you have to provide the existing ones from the Network plus the new alias IP in the request body. 
   * 
   * Expected answers:
   *   code 201 : ChangeAliasIpsOfNetworkResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def changeAliasIpsOfNetwork(id: Long, changeAliasIpsOfNetworkRequest: ChangeAliasIpsOfNetworkRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ChangeAliasIpsOfNetworkResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(changeAliasIpsOfNetworkRequest))
      .response(asJson[ChangeAliasIpsOfNetworkResponse])
   ...
   * 
   * Expected answers:
   *   code 201 : ChangeReverseDnsEntryForThisServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   * @param changeReverseDnsEntryForThisServerRequest Select the IP address for which to change the DNS entry by passing `ip`. It can be either IPv4 or IPv6. The target hostname is set by passing `dns_ptr`, which must be a fully qualified domain name (FQDN) without trailing dot.
   */
  def changeReverseDnsEntryForThisServer(id: Long, changeReverseDnsEntryForThisServerRequest: ChangeReverseDnsEntryForThisServerRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ChangeReverseDnsEntryForThisServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(changeReverseDnsEntryForThisServerRequest))
      .response(asJson[ChangeReverseDnsEntryForThisServerResponse])

  /**
   * Changes the protection configuration of the Server. 
   * 
   * Expected answers:
   *   code 201 : ChangeServerProtectionResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def changeServerProtection(id: Long, changeServerProtectionRequest: ChangeServerProtectionRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ChangeServerProtectionResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .response(asJson[ChangeServerProtectionResponse])
   ...
   * 
   * Expected answers:
   *   code 201 : ChangeTypeOfServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def changeTypeOfServer(id: Long, changeTypeOfServerRequest: ChangeTypeOfServerRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ChangeTypeOfServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(changeTypeOfServerRequest))
      .response(asJson[ChangeTypeOfServerResponse])
   ...
   * 
   * Expected answers:
   *   code 201 : CreateImageFromServerResponse (The `image` key in the reply contains an the created Image, which is an object with this structure.  The `action` key in the reply contains an Action object with this structure. )
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def createImageFromServer(id: Long, createImageFromServerRequest: CreateImageFromServerRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], CreateImageFromServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(createImageFromServerRequest))
      .response(asJson[CreateImageFromServerResponse])

  /**
   * Creates a new Server. Returns preliminary information about the Server as well as an Action that covers progress of creation. 
   * 
   * Expected answers:
   *   code 201 : CreateServerResponse (The `server` key in the reply contains a Server object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   * 
   * Expected answers:
   *   code 200 : DeleteServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def deleteServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], DeleteServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[DeleteServerResponse])

  /**
   * Detaches an ISO from a Server. In case no ISO Image is attached to the Server, the status of the returned Action is immediately set to `success`. 
   * 
   * Expected answers:
   *   code 201 : DetachIsoFromServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def detachIsoFromServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], DetachIsoFromServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[DetachIsoFromServerResponse])

  /**
   * Detaches a Server from a network. The interface for this network will vanish. 
   * 
   * Expected answers:
   *   code 201 : DetachServerFromNetworkResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def detachServerFromNetwork(id: Long, detachServerFromNetworkRequest: DetachServerFromNetworkRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], DetachServerFromNetworkResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(detachServerFromNetworkRequest))
      .response(asJson[DetachServerFromNetworkResponse])
   ...
   * 
   * Expected answers:
   *   code 201 : DisableBackupsForServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def disableBackupsForServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], DisableBackupsForServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[DisableBackupsForServerResponse])
   ...
   * 
   * Expected answers:
   *   code 201 : DisableRescueModeForServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def disableRescueModeForServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], DisableRescueModeForServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[DisableRescueModeForServerResponse])
   ...
   * 
   * Expected answers:
   *   code 201 : EnableAndConfigureBackupsForServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def enableAndConfigureBackupsForServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], EnableAndConfigureBackupsForServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[EnableAndConfigureBackupsForServerResponse])
   ...
   * 
   * Expected answers:
   *   code 201 : EnableRescueModeForServerResponse (The `root_password` key in the reply contains the root password that can be used to access the booted rescue system.  The `action` key in the reply contains an Action object with this structure. )
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def enableRescueModeForServer(id: Long, enableRescueModeForServerRequest: EnableRescueModeForServerRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], EnableRescueModeForServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(enableRescueModeForServerRequest))
      .response(asJson[EnableRescueModeForServerResponse])
   ...
   */
  def getActionForServer(id: Long, actionId: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetActionResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
   ...
   * 
   * Expected answers:
   *   code 200 : GetMetricsForServerResponse (The `metrics` key in the reply contains a metrics object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def getMetricsForServer(id: Long, `type`: Seq[String], start: String, end: String, step: Option[String] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetMetricsForServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[GetMetricsForServerResponse])

  /**
   * Returns a specific Server object. The Server must exist inside the Project. 
   * 
   * Expected answers:
   *   code 200 : GetServerResponse (The `server` key in the reply contains a Server object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def getServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/servers/${idPathParam}"
   ...
   */
  def getServerAction(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], GetActionResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
   ...
   */
  def listActionsForServer(id: Long, sort: Seq[String], status: Seq[String], page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ListActionsResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
   ...
   * @param perPage Maximum number of entries returned per page. For more information, see \"Pagination\".
   */
  def listServerActions(id: Seq[Long], sort: Seq[String], status: Seq[String], page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ListActionsResponse]] =
    val requestURL =
   ...
   * 
   * Expected answers:
   *   code 200 : ListServersResponse (A paged array of servers.)
   *              Headers :
   ...
   * @param status Filter resources by status. Can be used multiple times. The response will only contain the resources with the specified status. 
   * @param page Page number to return. For more information, see \"Pagination\".
   * @param perPage Maximum number of entries returned per page. For more information, see \"Pagination\".
   */
  def listServers(name: Option[String] = scala.None, labelSelector: Option[String] = scala.None, sort: Seq[String], status: Seq[String], page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ListServersResponse]] =
    val requestURL =
      uri"$baseUrl/servers"
   ...
   * 
   * Expected answers:
   *   code 201 : PowerOffServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def powerOffServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], PowerOffServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[PowerOffServerResponse])

  /**
   * Starts a Server by turning its power on. 
   * 
   * Expected answers:
   *   code 201 : PowerOnServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def powerOnServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], PowerOnServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[PowerOnServerResponse])
   ...
   * 
   * Expected answers:
   *   code 201 : RebuildServerFromImageResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   * @param rebuildServerFromImageRequest To select which Image to rebuild from you can either pass an ID or a name as the `image` argument. Passing a name only works for `system` Images since the other Image types do not have a name set.
   */
  def rebuildServerFromImage(id: Long, rebuildServerFromImageRequest: RebuildServerFromImageRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], RebuildServerFromImageResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(rebuildServerFromImageRequest))
      .response(asJson[RebuildServerFromImageResponse])

  /**
   * Removes a Server from a Placement Group. 
   * 
   * Expected answers:
   *   code 201 : RemoveFromPlacementGroupResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def removeFromPlacementGroup(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], RemoveFromPlacementGroupResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[RemoveFromPlacementGroupResponse])
   ...
   * 
   * Expected answers:
   *   code 200 : ReplaceServerResponse (The `server` key in the reply contains the updated Server.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   ...
   */
  def replaceServer(id: Long, replaceServerRequest: ReplaceServerRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ReplaceServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/servers/${idPathParam}"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(replaceServerRequest))
      .response(asJson[ReplaceServerResponse])

  /**
   * Requests credentials for remote access via VNC over websocket to keyboard, monitor, and mouse for a Server. The provided URL is valid for 1 minute, after this period a new url needs to be created to connect to the Server. How long the connection is open after the initial connect is not subject to this timeout. 
   * 
   * Expected answers:
   *   code 201 : RequestConsoleForServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def requestConsoleForServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], RequestConsoleForServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[RequestConsoleForServerResponse])
   ...
   * 
   * Expected answers:
   *   code 201 : ResetRootPasswordOfServerResponse (The `root_password` key in the reply contains the new root password that will be active if the Action succeeds.  The `action` key in the reply contains an Action object with this structure. )
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def resetRootPasswordOfServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ResetRootPasswordOfServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[ResetRootPasswordOfServerResponse])

  /**
   * Cuts power to a Server and starts it again. This forcefully stops it without giving the Server operating system time to gracefully stop. This may lead to data loss, it’s equivalent to pulling the power cord and plugging it in again. Reset should only be used when reboot does not work. 
   * 
   * Expected answers:
   *   code 201 : ResetServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def resetServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ResetServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[ResetServerResponse])
   ...
   * 
   * Expected answers:
   *   code 201 : ShutdownServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def shutdownServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ShutdownServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[ShutdownServerResponse])

  /**
   * Reboots a Server gracefully by sending an ACPI request. The Server operating system must support ACPI and react to the request, otherwise the Server will not reboot. 
   * 
   * Expected answers:
   *   code 201 : SoftRebootServerResponse (The `action` key in the reply contains an Action object with this structure.)
   * 
   * Available security schemes:
   *   APIToken (http)
   * 
   * @param id ID of the Server.
   */
  def softRebootServer(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], SoftRebootServerResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[SoftRebootServerResponse])
