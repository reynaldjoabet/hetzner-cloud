...
case class Servers[Auth <: hcloud.Authorization] private (
  ...
  /** Detaches an ISO from a Server. In case no ISO Image is attached to the
    ...
    *   ID of the Server.
    */
  def detachIsoFromServer(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Disables the automatic backup option and deletes all existing Backups for
    ...
    *   ID of the Server.
    */
  def disableBackupsForServer(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Disables the Hetzner Rescue System for a Server. This makes a Server start
    ...
    *   ID of the Server.
    */
  def disableRescueModeForServer(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Enables and configures the automatic daily backup option for the Server.
    ...
    *   ID of the Server.
    */
  def enableAndConfigureBackupsForServer(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[Either[ResponseException[
    String
  ...
  /** Returns a specific Action object for a Server.
    ...
    *   ID of the Action.
    */
  def getActionForServer(id: Long, actionId: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Returns a specific Action object.
    ...
    *   ID of the Action.
    */
  def getServerAction(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
    Either[ResponseException[String], GetActionResponse]
  ] =
  ...
  /** Removes a Server from a Placement Group.
    ...
    *   ID of the Server.
    */
  def removeFromPlacementGroup(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Updates a Server. You can update a Server’s name and a Server’s labels.
    ...
    */
  def replaceServer(id: Long, replaceServerRequest: ReplaceServerRequest)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Requests credentials for remote access via VNC over websocket to keyboard,
    ...
    *   ID of the Server.
    */
  def requestConsoleForServer(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Resets the root password. Only works for Linux systems that are running
    ...
    *   ID of the Server.
    */
  def resetRootPasswordOfServer(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Reboots a Server gracefully by sending an ACPI request. The Server
    ...
    *   ID of the Server.
    */
  def softRebootServer(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
