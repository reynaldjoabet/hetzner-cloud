...
import hcloud.models.GetServerType200Response
import hcloud.models.ListServerTypes200Response
...
case class ServerTypes[Auth <: hcloud.Authorization] private (
  ...
  /** Gets a specific Server type object.
    *
    * Expected answers: code 200 : GetServerType200Response (Request succeeded.)
  ...
  def getServerType(id: Long)(using
    ...
    Either[ResponseException[String], GetServerType200Response]
  ] =
    val idPathParam =
    ...
    basicRequest
      ...
      .auth(authConfig)
      .response(asJson[GetServerType200Response])

  /** Gets all Server type objects.
    *
    * Expected answers: code 200 : ListServerTypes200Response (Request
  ...
  def listServerTypes(
    ...
    Either[ResponseException[String], ListServerTypes200Response]
  ] =
    val requestURL =
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[ListServerTypes200Response])
