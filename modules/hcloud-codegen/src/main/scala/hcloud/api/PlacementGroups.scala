...
object PlacementGroups:
  ...
  ): PlacementGroups[hcloud.Authorization.NoAuthorization.type] =
    PlacementGroups(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(
      baseUrl: String,
      username: String,
      password: String
  ): PlacementGroups[hcloud.Authorization.BasicAuth] =
    PlacementGroups(baseUrl, hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(
      baseUrl: String,
      apiKey: String
  ): PlacementGroups[hcloud.Authorization.ApiKey] =
    PlacementGroups(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(
      baseUrl: String,
      token: String
  ): PlacementGroups[hcloud.Authorization.BearerToken] =
    PlacementGroups(baseUrl, hcloud.Authorization.BearerToken(token))

case class PlacementGroups[Auth <: hcloud.Authorization] private (
    baseUrl: String,
  ...
  /** Creates a new Placement Group.
    *
    * Expected answers: code 201 : CreatePlacementGroupResponse (Request
  ...
  /** Deletes a Placement Group.
    ...
    */
  def deletePlacementGroup(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ...
  /** Gets a specific Placement Group object.
    *
    * Expected answers: code 200 : PlacementGroupResponse (Request succeeded.)
    ...
    *   ID of the Placement Group.
    */
  def getPlacementGroup(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
    Either[ResponseException[String], PlacementGroupResponse]
  ] =
    val idPathParam =
      PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
  ...
  /** Returns all Placement Group objects.
    *
    * Expected answers: code 200 : PlacementGroupsResponse (Request succeeded.)
    * code 4xx : GetActions4xxResponse (Request failed with a user error.) code
    * 5xx : GetActions5xxResponse (Request failed with a server error.)
    *
    * Available security schemes: APIToken (http)
    ...
    * @param `type`
    *   Filter resources by type. May be used multiple times. The response will
  ...
  def listPlacementGroups(
    ...
    Either[ResponseException[String], PlacementGroupsResponse]
  ] =
    val requestURL =
      uri"$baseUrl/placement_groups"
        .addParams(
