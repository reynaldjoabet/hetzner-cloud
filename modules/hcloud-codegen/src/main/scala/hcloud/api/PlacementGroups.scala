...
import hcloud.models.PlacementGroupResponse
import hcloud.models.PlacementGroupsResponse
import hcloud.models.UpdatePlacementGroupRequest
...
case class PlacementGroups[Auth <: hcloud.Authorization] private (baseUrl: String, authConfig: hcloud.Authorization):
   ...
   * 
   * Expected answers:
   *   code 201 : CreatePlacementGroupResponse (Request succeeded.)
   ...
   * 
   * Expected answers:
   *   code 200 : PlacementGroupResponse (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   * @param id ID of the Placement Group.
   */
  def getPlacementGroup(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], PlacementGroupResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/placement_groups/${idPathParam}"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[PlacementGroupResponse])

  /**
   * Returns all Placement Group objects. 
   * 
   * Expected answers:
   *   code 200 : PlacementGroupsResponse (Request succeeded.)
   *   code 4xx : GetActions4xxResponse (Request failed with a user error.)
   *   code 5xx : GetActions5xxResponse (Request failed with a server error.)
   * 
   * Available security schemes:
   ...
   */
  def listPlacementGroups(sort: Seq[String], name: Option[String] = scala.None, labelSelector: Option[String] = scala.None, `type`: Seq[String], page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], PlacementGroupsResponse]] =
    val requestURL =
      uri"$baseUrl/placement_groups"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .response(asJson[PlacementGroupsResponse])
   ...
   * 
   * @param id ID of the Placement Group.
   * @param updatePlacementGroupRequest 
   */
  def updatePlacementGroup(id: Long, updatePlacementGroupRequest: UpdatePlacementGroupRequest)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], PlacementGroupResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/placement_groups/${idPathParam}"
    ...
    basicRequest
      ...
      .contentType("application/json")
      .auth(authConfig)
      .body(asJson(updatePlacementGroupRequest))
      .response(asJson[PlacementGroupResponse])
