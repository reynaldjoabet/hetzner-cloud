...
import hcloud.models.ImportZoneZonefileRequest
...
object ZoneActions:
  def apply(baseUrl: String = "https://api.hetzner.cloud/v1"): ZoneActions[hcloud.Authorization.NoAuthorization.type] = ZoneActions(baseUrl, hcloud.Authorization.NoAuthorization)
  def withBasicAuth(baseUrl: String, username: String, password: String): ZoneActions[hcloud.Authorization.BasicAuth] =
    ZoneActions(baseUrl, hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(baseUrl: String, apiKey: String): ZoneActions[hcloud.Authorization.ApiKey] =
    ZoneActions(baseUrl, hcloud.Authorization.ApiKey(apiKey))

  def withBearerTokenAuth(baseUrl: String, token: String): ZoneActions[hcloud.Authorization.BearerToken] =
    ZoneActions(baseUrl, hcloud.Authorization.BearerToken(token))

case class ZoneActions[Auth <: hcloud.Authorization] private (baseUrl: String, authConfig: hcloud.Authorization):
  def withBasicAuth(username: String, password: String): ZoneActions[hcloud.Authorization.BasicAuth] =
    copy(authConfig = hcloud.Authorization.BasicAuth(username, password))

  def withApiKeyAuth(apiKey: String): ZoneActions[hcloud.Authorization.ApiKey] =
    copy(authConfig = hcloud.Authorization.ApiKey(apiKey))

  def withNoAuth: ZoneActions[hcloud.Authorization.NoAuthorization.type] =
    copy(authConfig = hcloud.Authorization.NoAuthorization)

  def withBearerTokenAuth(token: String): ZoneActions[hcloud.Authorization.BearerToken] =
   ...
   */
  def getZoneAction(idOrName: String, actionId: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ActionResponse]] =
    val idOrNamePathParam = PathSerializable.serialize("id_or_name", idOrName, PathStyleFormat.SIMPLE, false)
   ...
   */
  def getZonesAction(id: Long)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ActionResponse]] =
   ...
   */
  def listZoneActions(idOrName: String, sort: Seq[String], status: Seq[String], page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ActionListResponseWithMeta]] =
    val idOrNamePathParam = PathSerializable.serialize("id_or_name", idOrName, PathStyleFormat.SIMPLE, false)
    val requestURL =
   ...
   * @param perPage Maximum number of entries returned per page. For more information, see \"[Pagination](#description/pagination)\".
   */
  def listZonesActions(id: Seq[Long], sort: Seq[String], status: Seq[String], page: Option[Long] = scala.None, perPage: Option[Long] = scala.None)(using Auth <:< hcloud.Authorization.BearerToken): sttp.client4.Request[Either[ResponseException[String], ActionListResponseWithMeta]] =
    val requestURL =
