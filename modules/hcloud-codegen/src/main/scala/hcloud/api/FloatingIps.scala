...
case class FloatingIps[Auth <: hcloud.Authorization] private (
  ...
  /** Changes the protection settings configured for the Floating IP.
    ...
    * @param body
    */
  def changeFloatingIpProtection(id: Long, body: Protection)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Change the reverse DNS records for this Floating IP. Allows to modify the
    ...
    */
  def changeReverseDnsRecordsForFloatingIp(id: Long, body: DnsPtr)(using
      Auth <:< hcloud.Authorization.BearerToken
  ...
  /** Create a Floating IP. Provide the `server` attribute to assign the
    ...
    *   mutually exclusive.
    */
  def createFloatingIp(createFloatingIpRequest: CreateFloatingIpRequest)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Returns a specific Action for a Floating IP.
    ...
    *   ID of the Action.
    */
  def getActionForFloatingIp(id: Long, actionId: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
  ...
  /** Returns a single Action.
    ...
    *   ID of the Action.
    */
  def getFloatingIpAction(id: Long)(using
      Auth <:< hcloud.Authorization.BearerToken
  ): sttp.client4.Request[
    Either[ResponseException[String], GetActionResponse]
  ] =
